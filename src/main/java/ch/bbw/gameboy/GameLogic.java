...
public class GameLogic implements ButtonController {
    ...
    public GameLogic(PixelGraphic graphic) {
        ...
        objects.add(new Enemy(new Sprite("enemy1.jpg", graphic), 30, 30, 15));
        objects.add(new Enemy(new Sprite("enemy2.jpeg", graphic), 50, 30, 15));
        objects.add(new Enemy(new Sprite("enemy3.jpg", graphic), 120, 30, 15));
        objects.add(new Enemy(new Sprite("enemy4.jpg", graphic), 80, 30, 15));
        objects.add(new Enemy(new Sprite("Endboss.jpg", graphic), 80, 40, 10));
